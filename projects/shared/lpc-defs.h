...
enum LPC_SETTING_IDS
{
  ...
  LPC_SETTING_ID_RIBBON_REL_FACTOR                = 9,       // ==> tTcdRange(256, 2560), formerly "upper ribbon factor"
...
enum LPC_REQUEST_IDS
{
  ...
  LPC_REQUEST_ID_CLEAR_STAT     = 0x0007,
};
...
enum LPC_NOTIFICATION_IDS
{
  ...
  LPC_NOTIFICATION_ID_KEYCNTR_DATA   = 0x0006,
  LPC_NOTIFICATION_ID_CLEAR_STAT     = 0x0007,
  LPC_NOTIFICATION_ID_TEST_MSG       = 0xFFFF,
};
