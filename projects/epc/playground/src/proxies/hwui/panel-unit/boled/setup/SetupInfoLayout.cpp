    ...
    : ControlWithChildren(Rect(0, 0, 256, 96))
{
  ...
  addControl(new Label({ SetupInfoTexts::getInfoContent(entry), 0 }, Rect(64, 0, 128, 12)));
  addControl(new InvertedLabel("Setup", Rect(0, 0, 64, 12)));
  m_content = addControl(new MultiLineLabel(Rect(0, 12, 256, 84), SetupInfoTexts::getInfoContent(entry)));
}
