...
public class LoadToPartMode implements CustomPresetSelection {

	private class LoadToPartModeData {
		public String m_selectedPreset;
		public String m_selectedBank;
		public VoiceGroup m_selectedVoiceGroup;
	};

	private final String m_originPreset = "";

	private LoadToPartModeData m_currentData;
	private LoadToPartModeData m_otherData;

	public LoadToPartMode() {
		...
		// m_currentData.m_selectedVoiceGroup = m_currentData.m_selectedPreset.isDual()
		// ? VoiceGroup.II : VoiceGroup.I;

		m_otherData.m_selectedBank = m_currentData.m_selectedBank;
		m_otherData.m_selectedPreset = m_currentData.m_selectedPreset;
		// m_otherData.m_selectedVoiceGroup = m_currentData.m_selectedPreset.isDual() ?
		// VoiceGroup.I : VoiceGroup.II;
	...
	public boolean canNext() {
		if (m_currentData.m_selectedPreset != null) {
			// boolean isLastPreset = m_currentData.m_selectedPreset.getNumber() <
			// m_currentData.m_selectedPreset
