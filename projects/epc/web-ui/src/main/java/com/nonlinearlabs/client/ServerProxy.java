...
public class ServerProxy {
	...
	public void newBankFromEditBuffer() {
		StaticURI.Path path = new StaticURI.Path("presets", "new-bank-from-edit-buffer");
		StaticURI.KeyValue x = new StaticURI.KeyValue("x", "0");
		StaticURI.KeyValue y = new StaticURI.KeyValue("y", "0");
	...
	public void createNewBankFromPreset(double x, double y, String p) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "create-new-bank-from-preset");
		StaticURI.KeyValue kx = new StaticURI.KeyValue("x", x);
		StaticURI.KeyValue ky = new StaticURI.KeyValue("y", y);
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("preset", p), kx, ky);
		queueJob(uri, false);
	}

	public void createNewBankFromPresets(double x, double y, String csv) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "create-new-bank-from-presets");
		StaticURI.KeyValue kx = new StaticURI.KeyValue("x", x);
		StaticURI.KeyValue ky = new StaticURI.KeyValue("y", y);
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("presets", csv), kx, ky);
		queueJob(uri, false);
	}
	...
	public void dropPresetsBelow(String csv, String anchor) {
	...
	public void dropPresetsTo(String csv, String anchor) {
	...
	public void overwritePreset(String preset) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "overwrite-preset");
		StaticURI uri = new StaticURI(path);
		queueJob(uri, false);
		RenameDialog.awaitNewPreset(preset);
	}

	public void movePresetTo(String p, String anchor) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "move-preset-to");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("presetToOverwrite", anchor),
				new StaticURI.KeyValue("overwriteWith", p));
		queueJob(uri, false);
	}

	public void insertPresetCopyAbove(String p, String anchor) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "copy-preset-above");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("presetToCopy", p),
				new StaticURI.KeyValue("anchor", anchor));
		queueJob(uri, false);
	}

	public void insertPresetCopyBelow(String p, String anchor) {
	...
	public void insertEditBufferAbove(String actionAnchor) {
		String uuid = Uuid.random();
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "insert-editbuffer-above");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("anchor", actionAnchor),
				new StaticURI.KeyValue("uuid", uuid));
		queueJob(uri, false);
		RenameDialog.awaitNewPreset(uuid);
	}

	public void insertEditBufferBelow(String actionAnchor) {
		String uuid = Uuid.random();
	...
	public void overwritePresetWithEditBuffer(String actionAnchor) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "overwrite-preset-with-editbuffer");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("presetToOverwrite", actionAnchor));
		queueJob(uri, false);

		if (actionAnchor != nonMaps.getNonLinearWorld().getParameterEditor().getLoadedPresetUUID())
			RenameDialog.awaitNewPreset(actionAnchor);
	}

	public void deletePreset(String preset, boolean withBank) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "delete-preset");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("uuid", preset),
	...
	public void appendPreset(String preset, String bank) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "append-preset-to-bank");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("bank-uuid", bank),
				new StaticURI.KeyValue("preset-uuid", preset));
		queueJob(uri, false);
	}

	public void appendEditBuffer(String bank) {
		String uuid = Uuid.random();
	...
	public void insertPreset(String selPreset) {
		if (selPreset == null) {
			appendPreset();
		} else {
			String uuidOfSelectedPreset = selPreset;
			String uuid = Uuid.random();
	...
	public void getDiff(String presetA, VoiceGroup vgOfPreset1, String presetB, VoiceGroup vgOfPreset2,
			DownloadHandler handler) {
		String aUUID = presetA != null ? presetA : "";
		String bUUID = presetB != null ? presetB : "";
	...
	public void dropPresetsOnBank(String csv, String bank) {
	...
	public void dropEditBufferOnBank(String b) {
		appendEditBuffer(b);
	}

	public void dropBankOnBank(String draggedBankUuid, String targetUuid) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "drop-bank-on-bank");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("receiver", targetUuid),
				new StaticURI.KeyValue("bank", draggedBankUuid));
		queueJob(uri, false);
	}

	public void insertBankAbove(String bank, String preset) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "insert-bank-above");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("bank", bank),
				new StaticURI.KeyValue("anchor", preset));
		queueJob(uri, false);
	}

	public void insertBankBelow(String bank, String preset) {
	...
	public void overwritePresetWithBank(String bank, String preset) {
	...
	public void setBankAttribute(String theBank, String key, String value) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "set-bank-attribute");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("uuid", theBank), new StaticURI.KeyValue("key", key),
	...
	public void sortBank(String bank, boolean asc) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "sort-bank");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("uuid", bank), new StaticURI.KeyValue("asc", asc));
		queueJob(uri, false);
	}
	...
	public void setPresetAttribute(String presets, String key, String value) {
		StaticURI.Path path = new StaticURI.Path("presets", "banks", "set-preset-attribute");
		StaticURI uri = new StaticURI(path, new StaticURI.KeyValue("csv", presets), new StaticURI.KeyValue("key", key),
				new StaticURI.KeyValue("value", value));
		queueJob(uri, false);
	}
	...
	public static class BankAndPosition {
		public BankAndPosition(String uuid, double x, double y) {
			this.uuid = uuid;
			this.x = x;
			this.y = y;
		}
	...
	public void setBankPositions(ArrayList<BankAndPosition> changedBanks) {
		String csv = "";
		for (var curr : changedBanks) {
			if (!csv.isEmpty())
				csv += ",";

			csv += curr.uuid + "," + curr.x + "," + curr.y;
		}
